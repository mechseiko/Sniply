...
const App = () => {
  ...
  const Shortener = () => (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-purple-50 flex flex-col justify-between">
      <main className="flex-grow">

        {/* Hero */}
        <section className="text-center py-16 px-4">
          <h1 className="text-6xl font-extrabold text-purple-700 mb-4 tracking-tight drop-shadow">
            Sniply
          </h1>
      ...
      {/* Footer */}
      <footer className="text-center text-sm text-gray-600 py-6 border-t border-gray-200 bg-white">
  ...
  const RedirectPage = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-purple-50 to-purple-100 px-4 text-center">
        <div>
          <h1 className="text-4xl font-bold text-purple-700 mb-4">Sniply Redirect</h1>
          {target ? (
            <p className="text-lg text-gray-700">
              Redirecting to{' '}
              <span className="text-purple-800 font-medium break-words">{target}</span> in{' '}
